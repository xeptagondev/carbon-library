    ...
    if (programmeDetails) {
      ...
      const valueSectoralScope = mitigationSubTypeList
        ? mitigationSubTypeList?.find((item: any) => item.label === key)
          ...
          : ""
        : "";
      setSubSector({ label: key, value: valueSectoralScope });
      console.log(
        "Sub Sector --- > ",
        mitigationSubTypeList?.find((item: any) => item.label === key),
        key,
      ...
      if (!ndcActionDetails) {
        ...
        form.setFieldsValue({
          mitigationType: sectorMitigationTypesListMapped[
            programmeDetails?.sector
          ]
            ? sectorMitigationTypesListMapped[programmeDetails?.sector]?.find(
                (item: any) => item.label === programmeDetails?.sector
              )?.label ?? ""
                          ...
                          mitigationSubTypesListMapped[
                            sectorMitigationTypesListMapped[
                              ...
                              ? sectorMitigationTypesListMapped[
                                  ...
                                  (item: any) =>
                                    item.label === programmeDetails?.sector
                                )?.label ?? ""
                              : ""
                          ]
                        }
