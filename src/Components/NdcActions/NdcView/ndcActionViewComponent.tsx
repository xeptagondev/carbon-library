...
export const NdcActionViewComponent = (props: any) => {
  ...
  const [canUploadMonitorReport, setCanUploadMonitorReport] =
  ...
  const ndcActionBasicDetails = {
    ...
    [t("ndcAction:viewNdcAction")]: getNdcActionNames(
      ndcActionDetails?.action as NdcActionTypes
    ),
  ...
  const getEnablementProperties = () => {
    ...
    if (ndcActionDetails?.enablementProperties) {
      details[t("ndcAction:title")] =
        ndcActionDetails.enablementProperties?.title;
      ...
      if (ndcActionDetails.enablementProperties?.report) {
        details[t("ndcAction:report")] = ndcActionDetails.enablementProperties
          ?.report && (
          <a
