...
export enum MitigationSubTypes {
  ...
  // Energy Sectoral Scope additions
...
export const mitigationTypeList = [
  ...
  //added later
  { value: MitigationTypes.ENERGY.valueOf(), label: "Energy" },
  { value: MitigationTypes.HEALTH.valueOf(), label: "Health" },
  { value: MitigationTypes.EDUCATION.valueOf(), label: "Education" },
  { value: MitigationTypes.MANUFACTURING.valueOf(), label: "Manufacturing" },
  { value: MitigationTypes.HOSPITALITY.valueOf(), label: "Hospitality" },
  { value: MitigationTypes.WASTE.valueOf(), label: "Waste" },
  { value: MitigationTypes.OTHER.valueOf(), label: "Other" },
];
...
export const sectorMitigationTypesListMapped: any = {
  ...
  Health: [{ value: MitigationTypes.HEALTH.valueOf(), label: "Health" }],
  Education: [{ value: MitigationTypes.EDUCATION.valueOf(), label: "Education" }],
  Transport: [
    { value: MitigationTypes.TRANSPORT.valueOf(), label: "Transport" },
  ],
  Manufacturing: [
  ...
  Hospitality: [{ value: MitigationTypes.HOSPITALITY.valueOf(), label: "Hospitality" }],
...
export const mitigationSubTypeList = [
  ...
  { label: "Energy Industries (Renewable – / Non-Renewable Sources)", value: MitigationSubTypes.ENERGY_INDUSTRIES.valueOf() },
  { label: "Energy Distribution", value: MitigationSubTypes.ENERGY_DISTRIBUTION.valueOf() },
  { label: "Energy Demand", value: MitigationSubTypes.ENERGY_DEMAND.valueOf() },
  { label: "Manufacturing Industries", value: MitigationSubTypes.MANUFACTURING_INDUSTRIES.valueOf() },
  { label: "Chemical Industries", value: MitigationSubTypes.CHEMICAL_INDUSTRIES.valueOf() },
  { label: "Construction", value: MitigationSubTypes.CONSTRUCTION.valueOf() },
  { label: "Transport", value: MitigationSubTypes.TRANSPORT.valueOf() },
  { label: "Mining/Mineral Production", value: MitigationSubTypes.MINING_MINERAL_PRODUCTION.valueOf() },
  { label: "Metal Production", value: MitigationSubTypes.METAL_PRODUCTION.valueOf() },
  { label: "Fugitive Emissions From Fuels (Solid, Oil and Gas)", value: MitigationSubTypes.FUGITIVE_EMISSIONS_FROM_FUELS.valueOf() },
  { label: "Fugitive Emissions From Production and Consumption of Halocarbons and Sulphur Hexafluoride", value: MitigationSubTypes.FUGITIVE_EMISSIONS_HALOCARBONS.valueOf() },
  { label: "Solvent Use", value: MitigationSubTypes.SOLVENT_USE.valueOf() },
  { label: "Waste Handling and Disposal", value: MitigationSubTypes.WASTE_HANDLING_DISPOSAL.valueOf() },
  { label: "Afforestation and Reforestation", value: MitigationSubTypes.AFFORESTATION_REFORESTATION.valueOf() },
  { label: "Agriculture", value: MitigationSubTypes.AGRICULTURE.valueOf() },
];
