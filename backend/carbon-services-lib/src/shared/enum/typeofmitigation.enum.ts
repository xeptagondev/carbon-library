...
export const mitigationTypeList: any = [
  ...
  'CO2Usage',
  'Tidal',
  'Energy',               // Missing from the original list
  'Health',               // Missing from the original list
  'Education',            // Missing from the original list
  'Manufacturing',        // Missing from the original list
  'Hospitality',          // Missing from the original list
  'Waste',                // Missing from the original list
  'Other'                 // Missing from the original list
];
...
export const sectorMitigationTypesListMapped: any = {
  ...
  Transport: ['Transport'],
  Manufacturing: ['Cement', 'CCS', 'HFC_PFCs_SF6'],
  Hospitality: [...mitigationTypeList],
  Forestry: ['Forestry'],
  Waste: ['Landfills', 'Fugitive', 'MethaneAvoidance'],
  Agriculture: ['Agriculture'],
  Other: ['Marine', 'N20', 'CO2Usage', 'Tidal'],
};
...
export const mitigationSubTypesListMapped: any = {
  Agriculture: [
    ...
    SubTypeOfMitigation.ENERGY_INDUSTRIES.valueOf(),
    SubTypeOfMitigation.ENERGY_DISTRIBUTION.valueOf(),
    SubTypeOfMitigation.ENERGY_DEMAND.valueOf(),
    SubTypeOfMitigation.MANUFACTURING_INDUSTRIES.valueOf(),
    SubTypeOfMitigation.CHEMICAL_INDUSTRIES.valueOf(),
    SubTypeOfMitigation.CONSTRUCTION.valueOf(),
    SubTypeOfMitigation.TRANSPORT.valueOf(),
    SubTypeOfMitigation.MINING_MINERAL_PRODUCTION.valueOf(),
    SubTypeOfMitigation.METAL_PRODUCTION.valueOf(),
    SubTypeOfMitigation.FUGITIVE_EMISSIONS_FROM_FUELS.valueOf(),
    SubTypeOfMitigation.FUGITIVE_EMISSIONS_HALOCARBONS.valueOf(),
    SubTypeOfMitigation.SOLVENT_USE.valueOf(),
    SubTypeOfMitigation.WASTE_HANDLING_DISPOSAL.valueOf(),
    SubTypeOfMitigation.AFFORESTATION_REFORESTATION.valueOf(),
    SubTypeOfMitigation.AGRICULTURE.valueOf(),
  ],
  BiomassEnergy: [
